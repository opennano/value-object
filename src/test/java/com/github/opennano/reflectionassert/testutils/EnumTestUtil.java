...
public class EnumTestUtil {
   ...
   * much sense :(
   *
   * @see https://stackoverflow.com/questions/4512358/emma-coverage-on-enum-types
   */
  public static <T extends Enum<T>> void assertEnumValid(Class<T> enumType) {
    try {
      ...
      throw new IllegalArgumentException("failed to call method valueOf on enum " + enumType.getSimpleName(), e);
    }
  }
}
